      ...
      cardContent: [
        Row(
          ...
          children: [
            ...
            AppActionMenu(
              items: [
                const AppActionMenuItem(value: 'details', label: 'Ver Detalle'),
                const AppActionMenuItem(value: 'edit', label: 'Editar'),
              ],
              onSelected: (value) => context.handleWorkAction(work, value),
            ),
          ],
        ),
        ...
        Row(
          ...
          children: [
            Column(
              ...
              children: [Text("CREACIÓN"), Text(work.creationDate.ddMMyyyy)],
            ),
